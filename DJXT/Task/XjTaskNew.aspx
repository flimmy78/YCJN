<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="XjTaskNew.aspx.cs" Inherits="DJXT.Task.XjTaskNew" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>点检任务完成情况查询</title>
    ...
    <script type="text/javascript">
		...
		function load(){
            $.post("XjTaskNew.aspx", { param: ''}, function (data) {
            ...
            $('#grid').datagrid({
			    ...
			    sortOrder: 'asc',
			    remoteSort: false,
			    queryParams:{param:'load'},
			    idField:'id',
//			    frozenColumns:[[
//                {field:'ck',checkbox:true}
//			    ]],
			    columns:[[				    		
				    {field:'parment',title:'点检部门',width:120,align:'center'},
